def divide(quotients, divisors):
    ...
    """
    return {element: [re_element for re_element in divisors if re_element % element == 0] for element in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    origin_dot = make_city('orgin', lat, lon)
    if distance(origin_dot, city_a) > distance(origin_dot, city_b):
